//
//  g/Grammar/ExtendedGrammar.h - Extened (BNF) Grammar
//
...
public:
    ExtendedGrammar(std::string name, Actions* actions) : ContextFreeGrammar(name, actions) { // TODO: Check nextNonTerminalSymbol(1)
    }
    ~ExtendedGrammar() {}
...
// End g/Grammar/ExtendedGrammar.h -
