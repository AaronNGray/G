//
//  g/TextualTemplate/TextualTemplate.cpp
//
...
std::string TextualTemplate::CodeBlock::Output() const {
    std::string s;
    std::cout << "CodeBlock(" << ::StringLiteral(code).toString() << ")" << std::endl;
    if (code == "" || code == "\n")
...
std::string TextualTemplate::ActionCode::Output() const {
    std::string s;
    std::cout << "ActionBlock(" << ::StringLiteral(code).toString() << ")" << std::endl;
    if (code == "" || code == "\n")
        s += nonstd::endl;
    else
        s += code;
...
std::string TextualTemplate::Parameter::Output() const {
    std::string s;
    std::cout << "Parameter(" << ::StringLiteral(code).toString() << ")" << std::endl;
    if (code == "" || code == "\n")
        s += nonstd::endl;
    else
...
// End g/TextualTemplate/TextualTemplate.cpp
