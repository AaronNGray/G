//
//	g/src/bootstrap/flex-bison-bootstrap/lg-bootstrap-lg-pg/main.cpp
//
...
int main(int argc, char *argv[]) {
	Logger logger(new StdErrLogger, "lg-bootstrap-lg-pg");
	...
	if (commandLine.getParameters() == 1) {
		try {
			...
			SourceFileParser<RegularGrammar, lgLexer, lgParser>* sourceFileParser = new SourceFileParser<RegularGrammar, lgLexer, lgParser>(filename, &logger, debug);
...
// End lg-bootstrap-lg-pg/main.cpp
