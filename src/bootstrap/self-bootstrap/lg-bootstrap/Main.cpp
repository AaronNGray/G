//
//	g/src/bootstrap/self-bootstrap/lg-bootstrap/main.cpp
//
...
int main(int argc, char *argv[]) {
	...
	if (commandLine.getParameters() == 1) {
		Logger logger(new StdErrLogger, "lg-bootstrap");
...
// End g/src/bootstrap/self-bootstrap/lg-bootstrap/main.cpp
